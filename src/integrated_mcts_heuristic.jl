...
for j in 1:num_runs
    ...
    for t = 0:time_step:2000
        ...
        print("\rMCTS with Heuristic Rollouts Progress $j: $bar_string $(round(progress, digits=2))%")
...
@save "mcts_heuristic_runs.jld2" state_list_mcts action_list_mcts along_ang_des_mcts mcts_observed_target_lambda mcts_observed_target_phi mcts_observed_target_reward mcts_num_observed mcts_reward_totals target_lambda target_phi target_mean_reward
println("DONE")